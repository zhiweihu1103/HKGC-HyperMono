...
class MoEPositionwiseFeedForward(FMoETransformerMLP):
    def __init__(self, d_model, d_inner, dropout, pre_lnorm=False, moe_num_expert=4, moe_top_k=2):
    ...
    def __init__(self, config, moe_mode=False):
        ...
        for i in range(config['num_hidden_layers']):
            ...
            if moe_mode == False:
                ...
                moe_num_expert = 16
                moe_top_k = 2
                ff = MoEPositionwiseFeedForward(config['hidden_size'], config['intermediate_size'] // moe_top_k,
                                                 config['hidden_dropout_prob'], True, moe_num_expert, moe_top_k)
